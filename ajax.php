...
switch ($action) {
    ...
    case 'ai_focus_helper':
        ...
        if ($orbokeneenabled) {
            ...
            $ngramcandidates = self::build_expression_candidates($fronttext, $span);
     ...
     * @return array
     */
    protected static function build_expression_candidates(string $fronttext, string $base): array {
        $cands = [];
