<?php
// Simple test page - no Moodle dependencies
// Can be accessed directly via: https://abcnorsk.no/mod/flashcards/test-debug.php

// Disable Moodle requirements to make this a standalone test page
  ...
  <script>
    ...
    function logHistory(event, metrics) {
      ...
      const historyText = history.map(h =>
        `${h.time} ${h.event}: vp=${h.viewportWidth} body=${h.bodyWidth} cont=${h.containerWidth} ${h.cropped ? '⚠️CROPPED' : '✓OK'}`
      ).join(' | ');
