...
$string['ai_chat_empty'] = 'Fai una domanda all\'AI per mantenere il contesto della spiegazione.';
...
$string['audio'] = 'Audio';
$string['order_audio_word'] = 'Audio (parola)';
$string['order_audio_text'] = 'Audio (testo)';
...
$string['dashboard_total_cards'] = 'Totale schede create';
