...
$string['fokus'] = 'Focus word/phrase';
...
$string['token_create_card'] = 'Create card';
$string['token_create_card_status'] = 'Card draft prepared';
$string['choose_focus_word'] = 'Choose focus word or phrase';
$string['sentence_analysis'] = 'Grammar & meaning breakdown';
$string['analysis_empty'] = 'Select a word to see the grammar breakdown.';
$string['check_text'] = 'Check text';
$string['checking_text'] = 'Checking text...';
$string['no_errors_found'] = 'No errors found!';
$string['errors_found'] = 'Errors found!';
$string['corrected_version'] = 'Corrected version:';
$string['apply_corrections'] = 'Apply corrections';
...
$string['image'] = 'Image';
$string['audio'] = 'Audio';
$string['order_audio_word'] = 'Focus audio';
...
$string['ocr_status_ready'] = 'Text recognized – adjust selection';
...
$string['ocr_text_select_title'] = 'Choose the part you need';
$string['ocr_text_select_hint'] = 'Drag the start and end handles to keep only the right fragment.';
$string['ocr_text_select_apply'] = 'Use selection';
$string['ocr_text_select_reset'] = 'Select all';
...
$string['resetform'] = 'Clear';
$string['addtomycards'] = 'Add to my cards';
$string['install_app'] = 'Install as app';
...
$string['settings_elevenlabs_language_code'] = 'ElevenLabs language code';
$string['settings_elevenlabs_language_code_desc'] = 'Language code sent to ElevenLabs (e.g. "no" for Norwegian).';
$string['settings_elevenlabs_focus_model'] = 'ElevenLabs model for focus/short prompts';
$string['settings_elevenlabs_focus_model_desc'] = 'Model ID used for focus audio and other very short prompts (default: eleven_v3).';
$string['settings_elevenlabs_focus_language_code'] = 'ElevenLabs language code for focus (optional)';
$string['settings_elevenlabs_focus_language_code_desc'] = 'If set, overrides the general ElevenLabs language code for focus audio.';
$string['settings_tts_short_provider'] = 'Provider for very short prompts';
$string['settings_tts_short_provider_desc'] = 'Which provider to prefer for very short texts (typically 1–2 words). Polly remains a fallback when the preferred provider is unavailable.';
$string['settings_tts_short_provider_auto'] = 'Auto (legacy: Polly first)';
$string['settings_tts_short_provider_elevenlabs'] = 'ElevenLabs (recommended)';
$string['settings_tts_short_provider_polly'] = 'Amazon Polly';
$string['settings_elevenlabs_focus_stability'] = 'Focus stability';
$string['settings_elevenlabs_focus_stability_desc'] = 'Higher values reduce variation for focus/short prompts (0.0–1.0).';
$string['settings_elevenlabs_focus_similarity_boost'] = 'Focus similarity boost';
$string['settings_elevenlabs_focus_similarity_boost_desc'] = 'Higher values preserve the voice identity for focus/short prompts (0.0–1.0).';
$string['settings_elevenlabs_focus_speed'] = 'Focus speed';
$string['settings_elevenlabs_focus_speed_desc'] = 'Lower values speak slower for focus/short prompts.';
$string['settings_elevenlabs_focus_previous_text'] = 'Focus previous text';
$string['settings_elevenlabs_focus_previous_text_desc'] = 'Optional non-spoken context for focus/short prompts. Leave empty to disable.';
