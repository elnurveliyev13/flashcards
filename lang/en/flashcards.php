...
$string['settings_ocr_section'] = 'Image-to-text recognition';
$string['settings_ocr_section_desc'] = 'Configure OCR.space so learners can scan photos directly into the Front field.';
$string['settings_ocr_enable'] = 'Enable image OCR';
$string['settings_ocr_enable_desc'] = 'Allow the Scan text button to call OCR.space through the Moodle server.';
$string['settings_ocr_key'] = 'OCR.space API key';
$string['settings_ocr_key_desc'] = 'Stored securely on the server; get a free key from ocr.space.';
$string['settings_ocr_language'] = 'OCR language';
$string['settings_ocr_language_desc'] = 'Three-letter code recognized by OCR.space (default eng).';
$string['settings_ocr_endpoint'] = 'OCR endpoint';
$string['settings_ocr_endpoint_desc'] = 'Override if you run an OCR.space compatible proxy.';
$string['settings_ocr_timeout'] = 'API timeout (seconds)';
$string['settings_ocr_timeout_desc'] = 'Abort stalled OCR requests after this many seconds.';
