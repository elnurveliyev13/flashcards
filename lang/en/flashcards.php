...
$string['settings_elevenlabs_focus_model_desc'] = 'Model ID used for focus audio and other very short prompts (1–3 words).';
...
$string['settings_elevenlabs_focus_previous_text_desc'] = 'Optional non-spoken context for focus/short prompts (1–3 words). Leave empty to disable.';
