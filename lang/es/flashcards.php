...
$string['ai_chat_empty'] = 'Haz una pregunta a la IA para mantener el contexto de la explicación.';
...
$string['image'] = 'Imagen';
$string['audio'] = 'Audio';
$string['order_audio_word'] = 'Audio (palabra)';
$string['order_audio_text'] = 'Audio (texto)';
