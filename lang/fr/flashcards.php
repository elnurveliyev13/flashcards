...
$string['ai_chat_empty'] = 'Posez une question à l\'IA pour conserver le contexte de l\'explication.';
...
$string['image'] = 'Image';
$string['audio'] = 'Audio';
$string['order_audio_word'] = 'Audio (mot)';
$string['order_audio_text'] = 'Audio (texte)';
