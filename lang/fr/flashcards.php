...
$string['choose_focus_word'] = 'Choisissez le mot ou la phrase focal';
...
$string['update_disabled_hint'] = 'Ouvrez d\'abord une carte existante pour activer Actualiser.';
...
$string['gender'] = 'Genre';
$string['gender_neuter'] = 'Neutre (intetkjønn)';
$string['gender_masculine'] = 'Masculin (hankjønn)';
$string['gender_feminine'] = 'Féminin (hunkjønn)';
