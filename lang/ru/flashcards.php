...
$string['spacy_active_status'] = 'spaCy обработал: {$a} токенов';
$string['spacy_inactive_status'] = 'spaCy-анализ недоступен';
$string['spacy_model_label'] = 'Модель: {$a}';
...
$string['settings_elevenlabs_focus_model_desc'] = 'ID модели для Focus audio и других очень коротких текстов (1–3 слова).';
...
$string['settings_elevenlabs_focus_previous_text_desc'] = 'Неозвучиваемый контекст для focus/коротких запросов (1–3 слова). Оставьте пустым, чтобы отключить.';
