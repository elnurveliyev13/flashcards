...
$string['settings_elevenlabs_language_code'] = 'Код языка ElevenLabs';
$string['settings_elevenlabs_language_code_desc'] = 'Код языка, отправляемый в ElevenLabs (например "no" для норвежского).';
$string['settings_elevenlabs_focus_model'] = 'Модель ElevenLabs для фокуса/коротких запросов';
$string['settings_elevenlabs_focus_model_desc'] = 'ID модели для Focus audio и других очень коротких текстов (по умолчанию: eleven_v3).';
$string['settings_elevenlabs_focus_language_code'] = 'Код языка ElevenLabs для фокуса (необязательно)';
$string['settings_elevenlabs_focus_language_code_desc'] = 'Если задан, переопределяет общий код языка ElevenLabs для Focus audio.';
$string['settings_tts_short_provider'] = 'Провайдер для очень коротких текстов';
$string['settings_tts_short_provider_desc'] = 'Какой провайдер предпочитать для очень коротких текстов (обычно 1–2 слова). Polly остаётся вариантом fallback, если выбранный провайдер недоступен.';
$string['settings_tts_short_provider_auto'] = 'Авто (как раньше: сначала Polly)';
$string['settings_tts_short_provider_elevenlabs'] = 'ElevenLabs (рекомендуется)';
