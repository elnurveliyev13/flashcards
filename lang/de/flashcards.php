...
$string['choose_focus_word'] = 'Fokuswort oder -phrase auswählen';
...
$string['ai_chat_empty'] = 'Stellen Sie der KI eine Frage zu Ihrem Text oder Fokuswort/-phrase';
$string['ai_chat_user'] = 'Sie';
$string['ai_chat_assistant'] = 'KI';
$string['ai_chat_error'] = 'Die KI konnte diese Frage nicht beantworten.';
$string['ai_chat_loading'] = 'Denkt nach...';
$string['check_text'] = 'Text überprüfen';
$string['no_errors_found'] = 'Keine Fehler gefunden!';
$string['apply_corrections'] = 'Korrekturen anwenden';
$string['keep_as_is'] = 'So lassen';
$string['error_checking_failed'] = 'Überprüfung fehlgeschlagen';
$string['naturalness_suggestion'] = 'Natürlichere Alternative:';
$string['ask_ai_about_correction'] = 'KI fragen';
$string['ai_sure'] = 'Bist du sicher?';
$string['ai_explain_more'] = 'Erkläre ausführlich';
$string['ai_more_examples'] = 'Gib mehr Beispiele';
$string['ai_thinking'] = 'Denkt nach...';
...
$string['image'] = 'Bild';
$string['audio'] = 'Audio';
$string['order_audio_word'] = 'Fokus-Audio';
...
$string['gender_neuter'] = 'Neutrum (intetkjønn)';
$string['gender_masculine'] = 'Maskulinum (hankjønn)';
$string['gender_feminine'] = 'Femininum (hunkjønn)';
...
$string['dashboard_total_cards'] = 'Gesamt Karten';
