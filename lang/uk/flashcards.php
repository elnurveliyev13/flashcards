...
$string['spacy_active_status'] = 'spaCy обробив: {$a} токенів';
$string['spacy_inactive_status'] = 'spaCy-аналіз недоступний';
...
$string['ocr_status_ready'] = 'Текст розпізнано — уточніть виділення';
...
$string['ocr_text_select_title'] = 'Обрати потрібний фрагмент';
$string['ocr_text_select_hint'] = 'Потягніть початковий і кінцевий повзунки, щоб залишити потрібний текст.';
$string['ocr_text_select_apply'] = 'Використати виділення';
$string['ocr_text_select_reset'] = 'Виділити все';
...
$string['gender'] = 'Рід';
$string['gender_neuter'] = 'Середній (intetkjønn)';
$string['gender_masculine'] = 'Чоловічий (hankjønn)';
$string['gender_feminine'] = 'Жіночий (hunkjønn)';
...
$string['dashboard_total_cards'] = 'Всього карток';
