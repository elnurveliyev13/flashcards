...
$string['ai_question_placeholder'] = 'Введіть запитання про це речення...';
$string['ai_question_button'] = 'Запитати';
$string['ai_chat_empty'] = 'Поставте запитання AI, щоб зберегти контекст пояснення.';
...
$string['audio'] = 'Аудіо';
$string['order_audio_word'] = 'Аудіо (слово)';
$string['order_audio_text'] = 'Аудіо (текст)';
